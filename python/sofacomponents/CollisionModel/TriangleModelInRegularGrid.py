...
def TriangleModelInRegularGrid(attachedTo , name='TriangleModelInRegularGrid', printLog=0, tags=[], bbox='1.79769e+308 1.79769e+308 1.79769e+308 -1.79769e+308 -1.79769e+308 -1.79769e+308', listening=0, active=1, moving=1, simulated=1, selfCollision=0, proximity=0.0, contactStiffness=10.0, contactFriction=0.0, contactRestitution=0.0, contactResponse='', color='1 0 0 1', group=[], bothSide=0, computeNormals=1, **kwargs):
...
Note that this is only indicative, and in particular if both collision models specify a different class it is up to the manager to choose.
    ...
    """
    return attachedTo.createObject("TriangleModelInRegularGrid" , name=name, printLog=printLog, tags=tags, bbox=bbox, listening=listening, active=active, moving=moving, simulated=simulated, selfCollision=selfCollision, proximity=proximity, contactStiffness=contactStiffness, contactFriction=contactFriction, contactRestitution=contactRestitution, contactResponse=contactResponse, color=color, group=group, bothSide=bothSide, computeNormals=computeNormals, **kwargs)
