...
def LCPConstraintSolver(attachedTo , tolerance, maxIt, name='LCPConstraintSolver', printLog=0, tags=[], bbox=array([[ 1.79769313e+308,  1.79769313e+308,  1.79769313e+308],
       [-1.79769313e+308, -1.79769313e+308, -1.79769313e+308]]), componentState='Undefined', listening=0, displayDebug=0, initial_guess=1, build_lcp=1, mu=0.6, minW=0.0, maxF=0.0, multi_grid=0, multi_grid_levels=2, merge_method=0, merge_spatial_step=2, merge_local_levels=2, group=[[0]], graph='', showLevels=0, showCellWidth=0.0, showTranslation=array([0., 0., 0.]), showLevelTranslation=array([0., 0., 0.]), **kwargs):
