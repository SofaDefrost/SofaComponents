...
def TaitSurfacePressureForceField(attachedTo , name='TaitSurfacePressureForceField', printLog=0, tags=[], bbox='1.79769e+308 1.79769e+308 1.79769e+308 -1.79769e+308 -1.79769e+308 -1.79769e+308', listening=1, isCompliance=0, rayleighStiffness=0.0, p0=0.0, B=0.0, gamma=0.0, injectedVolume=0.0, maxInjectionRate=1000.0, initialVolume=0.0, currentInjectedVolume=0.0, v0=0.0, currentVolume=0.0, currentPressure=0.0, currentStiffness=0.0, pressureTriangles=[], initialSurfaceArea=0.0, currentSurfaceArea=0.0, drawForceScale=0.001, drawForceColor=[[0.0, 1.0, 1.0, 1.0]], volumeAfterTC=0.0, surfaceAreaAfterTC=0.0, **kwargs):
