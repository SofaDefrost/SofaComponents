...
def SurfacePressureForceField(attachedTo , name='SurfacePressureForceField', printLog=0, tags=[], bbox='1.79769e+308 1.79769e+308 1.79769e+308 -1.79769e+308 -1.79769e+308 -1.79769e+308', listening=0, isCompliance=0, rayleighStiffness=0.0, pressure=0.0, min=[[0.0, 0.0, 0.0]], max=[[0.0, 0.0, 0.0]], triangleIndices=[], quadIndices=[], pulseMode=0, pressureLowerBound=0.0, pressureSpeed=0.0, volumeConservationMode=0, useTangentStiffness=1, defaultVolume=-1.0, mainDirection=[[0.0, 0.0, 0.0]], drawForceScale=0.0, **kwargs):
    """SurfacePressure
