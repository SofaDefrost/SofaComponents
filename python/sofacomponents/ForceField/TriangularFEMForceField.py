...
def TriangularFEMForceField(attachedTo , poissonRatio, youngModulus, name='TriangularFEMForceField', printLog=0, tags=[], bbox='1.79769e+308 1.79769e+308 1.79769e+308 -1.79769e+308 -1.79769e+308 -1.79769e+308', listening=0, isCompliance=0, rayleighStiffness=0.0, triangleInfo='', vertexInfo='', edgeInfo='', method='large', damping=0.0, rotatedInitialElements=[], initialTransformation=[], fracturable=0, hosfordExponant=1.0, criteriaValue=1000000000000000.0, showStressValue=0, showStressVector=0, showFracturableTriangles=0, computePrincipalStress=0, **kwargs):
    ...
    """
    return attachedTo.createObject("TriangularFEMForceField" , name=name, printLog=printLog, tags=tags, bbox=bbox, listening=listening, isCompliance=isCompliance, rayleighStiffness=rayleighStiffness, triangleInfo=triangleInfo, vertexInfo=vertexInfo, edgeInfo=edgeInfo, method=method, poissonRatio=poissonRatio, youngModulus=youngModulus, damping=damping, rotatedInitialElements=rotatedInitialElements, initialTransformation=initialTransformation, fracturable=fracturable, hosfordExponant=hosfordExponant, criteriaValue=criteriaValue, showStressValue=showStressValue, showStressVector=showStressVector, showFracturableTriangles=showFracturableTriangles, computePrincipalStress=computePrincipalStress, **kwargs)
