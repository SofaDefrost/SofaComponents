...
def TriangularBiquadraticSpringsForceField(attachedTo , name='TriangularBiquadraticSpringsForceField', printLog=0, tags=[], bbox='1.79769e+308 1.79769e+308 1.79769e+308 -1.79769e+308 -1.79769e+308 -1.79769e+308', listening=0, isCompliance=0, rayleighStiffness=0.0, triangleInfo='', edgeInfo='', initialPoints=[], poissonRatio=0.3, youngModulus=1000.0, dampingRatio=0.0, useAngularSprings=1, compressible=1, matrixRegularization=0.4, **kwargs):
    ...
    """
    return attachedTo.createObject("TriangularBiquadraticSpringsForceField" , name=name, printLog=printLog, tags=tags, bbox=bbox, listening=listening, isCompliance=isCompliance, rayleighStiffness=rayleighStiffness, triangleInfo=triangleInfo, edgeInfo=edgeInfo, initialPoints=initialPoints, poissonRatio=poissonRatio, youngModulus=youngModulus, dampingRatio=dampingRatio, useAngularSprings=useAngularSprings, compressible=compressible, matrixRegularization=matrixRegularization, **kwargs)
