...
def InteractionEllipsoidForceField(attachedTo , name='InteractionEllipsoidForceField', printLog=0, tags=[], bbox='1.79769e+308 1.79769e+308 1.79769e+308 -1.79769e+308 -1.79769e+308 -1.79769e+308', listening=0, isCompliance=0, rayleighStiffness=0.0, contacts='', center=[], vradius=[], stiffness=500.0, damping=5.0, color='0 0.5 1 1', draw=1, object2_dof_index=0, object2_forces=1, object2_invert=0, **kwargs):
