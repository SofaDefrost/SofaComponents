...
def TriangularQuadraticSpringsForceField(attachedTo , name='TriangularQuadraticSpringsForceField', printLog=0, tags=[], bbox='1.79769e+308 1.79769e+308 1.79769e+308 -1.79769e+308 -1.79769e+308 -1.79769e+308', listening=0, isCompliance=0, rayleighStiffness=0.0, initialPoints=[], poissonRatio=0.3, youngModulus=1000.0, dampingRatio=0.0, useAngularSprings=1, triangleInfo='', edgeInfo='', **kwargs):
    ...
    """
    return attachedTo.createObject("TriangularQuadraticSpringsForceField" , name=name, printLog=printLog, tags=tags, bbox=bbox, listening=listening, isCompliance=isCompliance, rayleighStiffness=rayleighStiffness, initialPoints=initialPoints, poissonRatio=poissonRatio, youngModulus=youngModulus, dampingRatio=dampingRatio, useAngularSprings=useAngularSprings, triangleInfo=triangleInfo, edgeInfo=edgeInfo, **kwargs)
