...
def VTKExporter(attachedTo , name='VTKExporter', printLog=0, tags=[], bbox=array([[ 1.79769313e+308,  1.79769313e+308,  1.79769313e+308],
       [-1.79769313e+308, -1.79769313e+308, -1.79769313e+308]]), componentState='Undefined', listening=0, filename='', XMLformat=1, position=array([], shape=(0, 3), dtype=float64), edges=1, triangles=0, quads=0, tetras=0, hexas=0, pointsDataFields=[], cellsDataFields=[], exportEveryNumberOfSteps=0, exportAtBegin=0, exportAtEnd=0, overwrite=0, **kwargs):
