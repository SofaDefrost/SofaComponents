...
def OglShader(attachedTo , name='OglShader', printLog=0, tags=[], bbox='1.79769e+308 1.79769e+308 1.79769e+308 -1.79769e+308 -1.79769e+308 -1.79769e+308', listening=0, turnOn=1, passive=0, fileVertexShaders="[ 'shaders/toonShading.vert' ]", fileFragmentShaders="[ 'shaders/toonShading.frag' ]", fileGeometryShaders='[]', fileTessellationControlShaders='[]', fileTessellationEvaluationShaders='[]', geometryInputType=-1, geometryOutputType=-1, geometryVerticesOut=-1, tessellationOuterLevel=1.0, tessellationInnerLevel=1.0, indexActiveShader=0, backfaceWriting=0, clampVertexColor=1, **kwargs):
    """OglShader
