...
def LightManager(attachedTo , name='LightManager', printLog=0, tags=[], bbox='1.79769e+308 1.79769e+308 1.79769e+308 -1.79769e+308 -1.79769e+308 -1.79769e+308', listening=1, shadows=0, softShadows=0, ambient='0 0 0 1', debugDraw=0, **kwargs):
    ...
    """
    return attachedTo.createObject("LightManager" , name=name, printLog=printLog, tags=tags, bbox=bbox, listening=listening, shadows=shadows, softShadows=softShadows, ambient=ambient, debugDraw=debugDraw, **kwargs)
