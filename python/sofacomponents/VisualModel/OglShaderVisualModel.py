...
def OglShaderVisualModel(attachedTo , name='OglShaderVisualModel', printLog=0, tags=[], bbox='1.79769e+308 1.79769e+308 1.79769e+308 -1.79769e+308 -1.79769e+308 -1.79769e+308', listening=0, position=[], restPosition=[], normal=[], initRestPositions=0, useNormals=1, updateNormals=1, computeTangents=0, updateTangents=1, handleDynamicTopology=1, fixMergedUVSeams=1, keepLines=0, vertices=[], texcoords=[], tangents=[], bitangents=[], edges=[], triangles=[], quads=[], vertPosIdx=[], vertNormIdx=[], fileMesh='', texturename='', translation=[[0.0, 0.0, 0.0]], rotation=[[0.0, 0.0, 0.0]], scale3d=[[1.0, 1.0, 1.0]], scaleTex=[[1.0, 1.0]], translationTex=[[0.0, 0.0]], material='Default Diffuse 1 0.75 0.75 0.75 1 Ambient 1 0.2 0.2 0.2 1 Specular 0 1 1 1 1 Emissive 0 0 0 0 0 Shininess 0 45 ', putOnlyTexCoords=0, srgbTexturing=0, materials='', groups='', blendTranslucency=1, premultipliedAlpha=0, useVBO=1, writeZTransparent=0, alphaBlend=0, depthTest=1, cullFace=0, lineWidth=1.0, pointSize=1.0, lineSmooth=0, pointSmooth=0, isToPrint=0, primitiveType='DEFAULT', blendEquation='GL_FUNC_ADD', sfactor='GL_SRC_ALPHA', dfactor='GL_ONE_MINUS_SRC_ALPHA', **kwargs):
