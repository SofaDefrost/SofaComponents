...
def ParabolicConstraint(attachedTo , name='ParabolicConstraint', printLog=0, tags=[], bbox='1.79769e+308 1.79769e+308 1.79769e+308 -1.79769e+308 -1.79769e+308 -1.79769e+308', listening=0, group=0, endTime=-1.0, indices=[], P1=[[0.0, 0.0, 0.0]], P2=[[0.0, 0.0, 0.0]], P3=[[0.0, 0.0, 0.0]], BeginTime=0.0, EndTime=0.0, **kwargs):
...
Use a negative value for infinite constraints
    ...
    """
    return attachedTo.createObject("ParabolicConstraint" , name=name, printLog=printLog, tags=tags, bbox=bbox, listening=listening, group=group, endTime=endTime, indices=indices, P1=P1, P2=P2, P3=P3, BeginTime=BeginTime, EndTime=EndTime, **kwargs)
