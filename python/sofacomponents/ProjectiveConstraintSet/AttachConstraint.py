...
def AttachConstraint(attachedTo , name='AttachConstraint', printLog=0, tags=[], bbox='1.79769e+308 1.79769e+308 1.79769e+308 -1.79769e+308 -1.79769e+308 -1.79769e+308', listening=0, group=0, endTime=-1.0, indices1=[], indices2=[], radius=-1.0, twoWay=0, freeRotations=0, lastFreeRotation=0, restRotations=0, lastPos=[[0.0, 0.0, 0.0]], lastDir=[[0.0, 0.0, 0.0]], clamp=0, minDistance=-1.0, positionFactor=1.0, velocityFactor=1.0, responseFactor=1.0, constraintFactor=[], **kwargs):
...
Use a negative value for infinite constraints
		 ...
		 radius: Radius to search corresponding fixed point if no indices are given
