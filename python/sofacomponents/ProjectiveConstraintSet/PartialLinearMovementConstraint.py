...
def PartialLinearMovementConstraint(attachedTo , name='PartialLinearMovementConstraint', printLog=0, tags=[], bbox='1.79769e+308 1.79769e+308 1.79769e+308 -1.79769e+308 -1.79769e+308 -1.79769e+308', listening=0, group=0, endTime=-1.0, indices=[[0]], keyTimes=[[0.0]], movements=[[0.0, 0.0, 0.0]], showMovement=0, linearMovementBetweenNodesInIndices=0, mainIndice=0, minDepIndice=0, maxDepIndice=0, imposedDisplacmentOnMacroNodes=[], X0=0.0, Y0=0.0, Z0=0.0, movedDirections=[[1, 1, 1]], **kwargs):
