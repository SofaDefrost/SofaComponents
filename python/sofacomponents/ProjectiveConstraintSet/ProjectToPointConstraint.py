...
def ProjectToPointConstraint(attachedTo , name='ProjectToPointConstraint', printLog=0, tags=[], bbox='1.79769e+308 1.79769e+308 1.79769e+308 -1.79769e+308 -1.79769e+308 -1.79769e+308', listening=0, group=0, endTime=-1.0, indices=[[0]], point=[[0.0, 0.0, 0.0]], fixAll=0, drawSize=0.0, **kwargs):
...
Use a negative value for infinite constraints
    ...
    """
    return attachedTo.createObject("ProjectToPointConstraint" , name=name, printLog=printLog, tags=tags, bbox=bbox, listening=listening, group=group, endTime=endTime, indices=indices, point=point, fixAll=fixAll, drawSize=drawSize, **kwargs)
