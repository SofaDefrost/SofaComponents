...
def MinProximityIntersection(attachedTo , alarmDistance, contactDistance, name='MinProximityIntersection', printLog=0, tags=[], bbox='1.79769e+308 1.79769e+308 1.79769e+308 -1.79769e+308 -1.79769e+308 -1.79769e+308', listening=0, useSphereTriangle=1, usePointPoint=1, useSurfaceNormals=0, useLinePoint=1, useLineLine=1, **kwargs):
    ...
    """
    return attachedTo.createObject("MinProximityIntersection" , name=name, printLog=printLog, tags=tags, bbox=bbox, listening=listening, alarmDistance=alarmDistance, contactDistance=contactDistance, useSphereTriangle=useSphereTriangle, usePointPoint=usePointPoint, useSurfaceNormals=useSurfaceNormals, useLinePoint=useLinePoint, useLineLine=useLineLine, **kwargs)
