...
def NonUniformHexahedralFEMForceFieldAndMass(attachedTo , poissonRatio, youngModulus, name='NonUniformHexahedralFEMForceFieldAndMass', printLog=0, tags=[], bbox='1.79769e+308 1.79769e+308 1.79769e+308 -1.79769e+308 -1.79769e+308 -1.79769e+308', listening=0, isCompliance=0, rayleighStiffness=0.0, separateGravity=0, rayleighMass=0.0, method='large', drawing=1, hexahedronInfo='', density=1.0, lumpedMass=0, massMatrices=[], totalMass=[], particleMasses=[], lumpedMasses=[], recursive=0, useMBK=1, **kwargs):
    ...
    Args:
		 ...
		 recursive: Use recursive matrix computation

		 useMBK: compute MBK and use it in addMBKdx, instead of using addDForce and addMDx.


    """
    return attachedTo.createObject("NonUniformHexahedralFEMForceFieldAndMass" , name=name, printLog=printLog, tags=tags, bbox=bbox, listening=listening, isCompliance=isCompliance, rayleighStiffness=rayleighStiffness, separateGravity=separateGravity, rayleighMass=rayleighMass, method=method, poissonRatio=poissonRatio, youngModulus=youngModulus, drawing=drawing, hexahedronInfo=hexahedronInfo, density=density, lumpedMass=lumpedMass, massMatrices=massMatrices, totalMass=totalMass, particleMasses=particleMasses, lumpedMasses=lumpedMasses, recursive=recursive, useMBK=useMBK, **kwargs)
