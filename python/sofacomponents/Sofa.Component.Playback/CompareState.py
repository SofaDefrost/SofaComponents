...
def CompareState(attachedTo , name='CompareState', printLog=0, tags=[], bbox=array([[ 1.79769313e+308,  1.79769313e+308,  1.79769313e+308],
    ...
    """
    return attachedTo.createObject("CompareState" , name=name, printLog=printLog, tags=tags, bbox=bbox, componentState=componentState, listening=listening, filename=filename, interval=interval, shift=shift, loop=loop, scalePos=scalePos, rotation=rotation, translation=translation, **kwargs)
