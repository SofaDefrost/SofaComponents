...
def RuleBasedContactManager(attachedTo , name='RuleBasedContactManager', printLog=0, tags=[], bbox=array([[ 1.79769313e+308,  1.79769313e+308,  1.79769313e+308],
       [-1.79769313e+308, -1.79769313e+308, -1.79769313e+308]]), componentState='Undefined', listening=0, response='PenalityContactForceField', responseParams='', variables='', rules=[], **kwargs):
...
Rules are applied in the order they are specified. If none match a given contact, the default response is used.
    ...
    """
    return attachedTo.createObject("RuleBasedContactManager" , name=name, printLog=printLog, tags=tags, bbox=bbox, componentState=componentState, listening=listening, response=response, responseParams=responseParams, variables=variables, rules=rules, **kwargs)
