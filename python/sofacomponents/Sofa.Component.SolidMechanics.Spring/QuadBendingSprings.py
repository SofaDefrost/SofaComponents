...
def QuadBendingSprings(attachedTo , name='QuadBendingSprings', printLog=0, tags=[], bbox=array([[ 1.79769313e+308,  1.79769313e+308,  1.79769313e+308],
       [-1.79769313e+308, -1.79769313e+308, -1.79769313e+308]]), componentState='Undefined', listening=0, isCompliance=0, rayleighStiffness=0.0, stiffness=100.0, damping=5.0, showArrowSize=0.009999999776482582, drawMode=0, spring=[], springsIndices1=array([], dtype=int32), springsIndices2=array([], dtype=int32), indices1=array([], dtype=int32), indices2=array([], dtype=int32), lengths=array([], dtype=float64), localRange=array([-1, -1], dtype=int32), **kwargs):
...
- 2: Arrow
    ...
    """
    return attachedTo.createObject("QuadBendingSprings" , name=name, printLog=printLog, tags=tags, bbox=bbox, componentState=componentState, listening=listening, isCompliance=isCompliance, rayleighStiffness=rayleighStiffness, stiffness=stiffness, damping=damping, showArrowSize=showArrowSize, drawMode=drawMode, spring=spring, springsIndices1=springsIndices1, springsIndices2=springsIndices2, indices1=indices1, indices2=indices2, lengths=lengths, localRange=localRange, **kwargs)
