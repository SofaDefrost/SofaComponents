...
def StiffSpringForceField(attachedTo , name='StiffSpringForceField', printLog=0, tags=[], bbox=array([[ 1.79769313e+308,  1.79769313e+308,  1.79769313e+308],
...
- 2: Arrow
    ...
    """
    return attachedTo.createObject("StiffSpringForceField" , name=name, printLog=printLog, tags=tags, bbox=bbox, componentState=componentState, listening=listening, isCompliance=isCompliance, rayleighStiffness=rayleighStiffness, stiffness=stiffness, damping=damping, showArrowSize=showArrowSize, drawMode=drawMode, spring=spring, springsIndices1=springsIndices1, springsIndices2=springsIndices2, indices1=indices1, indices2=indices2, lengths=lengths, **kwargs)
