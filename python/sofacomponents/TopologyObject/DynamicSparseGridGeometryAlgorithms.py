...
"""
Component DynamicSparseGridGeometryAlgorithms

.. autofunction:: DynamicSparseGridGeometryAlgorithms
...
def DynamicSparseGridGeometryAlgorithms(attachedTo , name='DynamicSparseGridGeometryAlgorithms', printLog=0, tags=[], bbox='1.79769e+308 1.79769e+308 1.79769e+308 -1.79769e+308 -1.79769e+308 -1.79769e+308', listening=0, showIndicesScale=0.019999999552965164, showPointIndices=0, tagMechanics='', showEdgeIndices=0, drawEdges=0, drawColorEdges='0.4 1 0.3 1', showQuadIndices=0, drawQuads=0, drawColorQuads=[[0.0, 0.4000000059604645, 0.4000000059604645]], showHexaIndices=0, drawHexahedra=0, drawScaleHexahedra=1.0, drawColorHexahedra=[[1.0, 0.5, 0.0]], **kwargs):
