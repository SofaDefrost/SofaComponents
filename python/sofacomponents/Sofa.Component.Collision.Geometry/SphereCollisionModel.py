...
"""
Component SphereCollisionModel

.. autofunction:: SphereCollisionModel
...
def SphereCollisionModel(attachedTo , name='SphereCollisionModel', printLog=0, tags=[], bbox=array([[ 1.79769313e+308,  1.79769313e+308,  1.79769313e+308],
       [-1.79769313e+308, -1.79769313e+308, -1.79769313e+308]]), componentState='Undefined', listening=0, active=1, moving=1, simulated=1, selfCollision=0, proximity=0.0, contactStiffness=10.0, contactFriction=0.0, contactRestitution=0.0, contactResponse='', color=array([1., 0., 0., 1.], dtype=float32), group=[], numberOfContacts=0, listRadius=array([], dtype=float64), radius=1.0, showImpostors=1, **kwargs):
...
Note that this is only indicative, and in particular if both collision models specify a different class it is up to the manager to choose.
		 ...
		 radius: Default Radius. (default=1.0)

		 showImpostors: Draw spheres as impostors instead of "real" spheres


    """
    return attachedTo.createObject("SphereCollisionModel" , name=name, printLog=printLog, tags=tags, bbox=bbox, componentState=componentState, listening=listening, active=active, moving=moving, simulated=simulated, selfCollision=selfCollision, proximity=proximity, contactStiffness=contactStiffness, contactFriction=contactFriction, contactRestitution=contactRestitution, contactResponse=contactResponse, color=color, group=group, numberOfContacts=numberOfContacts, listRadius=listRadius, radius=radius, showImpostors=showImpostors, **kwargs)
