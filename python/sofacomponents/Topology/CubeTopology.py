...
"""
Component CubeTopology

.. autofunction:: CubeTopology
...
def CubeTopology(attachedTo , name='CubeTopology', printLog=0, tags=[], bbox='1.79769e+308 1.79769e+308 1.79769e+308 -1.79769e+308 -1.79769e+308 -1.79769e+308', listening=0, fileTopology='', position=[], edges=[], triangles=[], quads=[], tetrahedra=[], isToPrint=0, hexahedra=[], uv=[], drawEdges=0, drawTriangles=0, drawQuads=0, drawTetrahedra=0, drawHexahedra=0, nx=0, ny=0, nz=0, internalPoints=0, splitNormals=0, min=[[0.0, 0.0, 0.0]], max=[[1.0, 1.0, 1.0]], **kwargs):
