...
"""
Component CylinderGridTopology

.. autofunction:: CylinderGridTopology
...
def CylinderGridTopology(attachedTo , name='CylinderGridTopology', printLog=0, tags=[], bbox='1.79769e+308 1.79769e+308 1.79769e+308 -1.79769e+308 -1.79769e+308 -1.79769e+308', listening=0, fileTopology='', position=[], edges=[[0, 1], [2, 3], [4, 5], [6, 7], [0, 2], [1, 3], [4, 6], [5, 7], [0, 4], [1, 5], [2, 6], [3, 7]], triangles=[[0, 1, 3], [0, 3, 2], [4, 5, 7], [4, 7, 6], [0, 1, 5], [0, 5, 4], [2, 3, 7], [2, 7, 6], [0, 2, 6], [0, 6, 4], [1, 3, 7], [1, 7, 5]], quads=[[0, 1, 3, 2], [4, 5, 7, 6], [0, 1, 5, 4], [2, 3, 7, 6], [0, 2, 6, 4], [1, 3, 7, 5]], tetrahedra=[], isToPrint=0, hexahedra=[[0, 1, 3, 2, 4, 5, 7, 6]], uv=[], drawEdges=0, drawTriangles=0, drawQuads=0, drawTetrahedra=0, drawHexahedra=0, n=[[2, 2, 2]], computeHexaList=1, computeQuadList=1, computeEdgeList=1, computePointList=1, createTexCoords=0, center=[[0.0, 0.0, 0.0]], axis=[[0.0, 0.0, 1.0]], radius=1.0, length=1.0, **kwargs):
    """Cylinder grid in 3D
