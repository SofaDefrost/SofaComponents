...
"""
Component SparseGridTopology

.. autofunction:: SparseGridTopology
...
def SparseGridTopology(attachedTo , name='SparseGridTopology', printLog=0, tags=[], bbox='1.79769e+308 1.79769e+308 1.79769e+308 -1.79769e+308 -1.79769e+308 -1.79769e+308', listening=0, fileTopology='', position=[], edges=[], triangles=[], quads=[], tetrahedra=[], isToPrint=0, hexahedra=[], uv=[], drawEdges=0, drawTriangles=0, drawQuads=0, drawTetrahedra=0, drawHexahedra=0, fillWeighted=1, onlyInsideCells=0, n=[[2, 2, 2]], min=[[0.0, 0.0, 0.0]], max=[[0.0, 0.0, 0.0]], cellWidth=0.0, nbVirtualFinerLevels=0, dataResolution=[[0, 0, 0]], voxelSize=[[1.0, 1.0, 1.0]], marchingCubeStep=1, convolutionSize=0, vertices=[], facets=[], input_triangles=[], input_quads=[], **kwargs):
    """Sparse grid in 3D
