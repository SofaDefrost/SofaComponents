...
def MeshExporter(attachedTo , name='MeshExporter', printLog=0, tags=[], bbox='1.79769e+308 1.79769e+308 1.79769e+308 -1.79769e+308 -1.79769e+308 -1.79769e+308', listening=0, filename='', exportEveryNumberOfSteps=0, exportAtBegin=0, exportAtEnd=0, enable=1, format='ALL', position=[], edges=1, triangles=1, quads=1, tetras=1, hexas=1, **kwargs):
