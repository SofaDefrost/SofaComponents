...
def OglOITShader(attachedTo , name='OglOITShader', printLog=0, tags=[], bbox=array([[ 1.79769313e+308,  1.79769313e+308,  1.79769313e+308],
       [-1.79769313e+308, -1.79769313e+308, -1.79769313e+308]]), componentState='Undefined', listening=0, turnOn=1, passive=0, fileVertexShaders="[ 'shaders/orderIndependentTransparency/accumulation.vert' ]", fileFragmentShaders="[ 'shaders/orderIndependentTransparency/accumulation.frag' ]", fileGeometryShaders='[]', fileTessellationControlShaders='[]', fileTessellationEvaluationShaders='[]', geometryInputType=-1, geometryOutputType=-1, geometryVerticesOut=-1, tessellationOuterLevel=1.0, tessellationInnerLevel=1.0, indexActiveShader=0, backfaceWriting=0, clampVertexColor=1, **kwargs):
    """OglOITShader
