...
def OglTexture2D(attachedTo , name='OglTexture2D', printLog=0, tags=[], bbox=array([[ 1.79769313e+308,  1.79769313e+308,  1.79769313e+308],
       [-1.79769313e+308, -1.79769313e+308, -1.79769313e+308]]), componentState='Undefined', listening=0, id='', indexShader=0, filename='', textureUnit=1, enabled=1, repeat=0, linearInterpolation=1, generateMipmaps=1, srgbColorspace=0, minLod=-1000.0, maxLod=1000.0, proceduralTextureWidth=0, proceduralTextureHeight=0, proceduralTextureNbBits=1, proceduralTextureData=array([], dtype=int32), cubemapFilenamePosX='', cubemapFilenamePosY='', cubemapFilenamePosZ='', cubemapFilenameNegX='', cubemapFilenameNegY='', cubemapFilenameNegZ='', texture2DFilename='', **kwargs):
    """OglTexture2D
