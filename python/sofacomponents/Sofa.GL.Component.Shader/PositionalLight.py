...
def PositionalLight(attachedTo , name='PositionalLight', printLog=0, tags=[], bbox=array([[ 1.79769313e+308,  1.79769313e+308,  1.79769313e+308],
      ...
      dtype=float32), fixed=0, position=array([-0.7,  0.3,  0. ]), attenuation=0.0, **kwargs):
